        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-3">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Detail Transaksi Keluar
                        <!--begin::Separator-->
                    ...
                    <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">Detail Transaksi Keluar</span>
                                    <span class="text-muted mt-1 fw-bold fs-7">Detail transaksi keluar</span>
                                </h3>
                            </div>
                            <!--end::Header-->
                            <!--begin::Body-->
                            <div class="card-body py-3 pt-10">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-sm btn-light-danger mt-10 mb-10 me-5">
