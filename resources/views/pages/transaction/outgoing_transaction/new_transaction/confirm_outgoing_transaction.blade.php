        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-3">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Konfirmasi Transaksi Keluar
                        <!--begin::Separator-->
                    ...
                    <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">Konfirmasi Transaksi Keluar</span>
                                    <span class="text-muted mt-1 fw-bold fs-7">Mengkonfirmasi transaksi keluar yang akan dibayar</span>
                                </h3>
                            </div>
                            <!--end::Header-->
                            <!--begin::Body-->
                            <div class="card-body py-3 pt-10">
                                <form action="{{ route('outgoing-transaction.update', \Crypt::encrypt($transaction->id)) }}" method="POST">
                                    @csrf
                                    @method('PUT')
