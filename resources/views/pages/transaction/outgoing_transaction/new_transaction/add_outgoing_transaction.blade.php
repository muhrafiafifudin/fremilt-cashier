        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-3">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Tambah Transaksi Keluar
                        <!--begin::Separator-->
                    ...
                    <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">Tambah Transaksi Keluar</span>
                                    <span class="text-muted mt-1 fw-bold fs-7">Menambahkan transaksi keluar yang diperlukan</span>
                                </h3>
                                <div class="card-toolbar">
                                    <a href="{{ route('outgoing-transaction.create') }}" class="btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#modal_add_product">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                @foreach ($products as $product)
                                                                    <tr>
                                                                        ...
                                                                        <td align="center" valign="middle">
                                                                            @if ($product->stock !== 0)
                                                                                <form action="{{ route('outgoing-transaction.add-product') }}" method="POST">
                                                                                    @csrf
                                                                                    @method('POST')
                            ...
                            <div class="card-body py-3 pt-10">
                                <form action="{{ route('outgoing-transaction.store') }}" method="POST">
                                    @csrf
                                    @method('POST')
                                                    ...
                                                    <tr class="product-data">
                                                        ...
                                                        <td align="center">
                                                            ...
                                                            <div class="position-relative w-lg-200px m-0-auto" id="kt_modal_create_project_budget_setup" data-kt-dialer="true" data-kt-dialer-min="1" data-kt-dialer-max="{{ $cart_item->product->stock }}" data-kt-dialer-step="1" data-kt-dialer-suffix=" pcs">
                                                                ...
                                                                <!--begin::Input control-->
                                                                <input type="text" class="form-control form-control-solid border-0 text-center qty-input" data-kt-dialer-control="input" placeholder="Amount" name="product[product_qty[]]" readonly="readonly" value="{{ $cart_item->product_qty }}" />
                                                                <!--end::Input control-->
                                    ...
                                    <div class="text-center">
                                        ...
                                        <button type="submit" class="btn btn-sm btn-light-primary mt-10 mb-10">
                                            ...
                                            <!--end::Svg Icon-->Tambah Transaksi Keluar
                                        </button>
                                    </div>
                                </form>
                            </div>
