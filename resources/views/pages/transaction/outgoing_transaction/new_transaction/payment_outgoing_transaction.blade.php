        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-3">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Pembayaran Transaksi Keluar
                        <!--begin::Separator-->
                    ...
                    <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">Pembayaran Transaksi Keluar</span>
                                    <span class="text-muted mt-1 fw-bold fs-7">Proses transaksi keluar yang akan dibayar</span>
                                </h3>

                                <form action="{{ route('outgoing-transaction.add-payment') }}" id="submit_form" method="POST">
                                    @csrf
                            ...
                            <div class="card-body py-3 pt-10">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="add_outgoing_transaction_table" class="table table-striped border rounded gy-5 gs-7 dataTable no-footer">
                                        ...
                                        <tfoot>
                                            <input type="hidden" id="total_outgoing_transaction" value="{{ $subTotal }}">
                                            ...
                                            @if ($transaction->payment_type == 1)
                                                <tr class="fw-bold fs-6 text-dark">
                                                    ...
                                                    <th align="center">
                                                        <input type="text" id="payment_outgoing_transaction" name="payment" class="form-control form-control-solid text-center payment-input" />
                                                    </th>
                                                </tr>
                                                <tr class="fw-bold fs-6 text-dark">
                                ...
                                <div class="text-center">
                                    @if ($transaction->payment_type == 1)
                                        <form action="{{ route('outgoing-transaction.add-payment') }}" method="POST">
                                            @csrf
                                            @method('POST')
