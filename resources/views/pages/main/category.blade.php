            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-3">
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Kategori
                        ...
                        <!--end::Separator-->
                        <!--begin::Description-->
                        <small class="text-muted fs-7 fw-bold my-1 ms-1">Halaman Kategori</small>
                        <!--end::Description-->
                    </h1>
                    <!--end::Title-->
                </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    ...
                                    <span class="text-muted mt-1 fw-bold fs-7">Menampilkan semua kategori yang ada</span>
                                </h3>
                                            ...
                                            <div class="modal-body px-10 px-lg-15 pt-0 pb-15">
                                                ...
                                                <div class="scroll-y me-n7 pe-7" id="kt_modal_new_target_form" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
                                                    ...
                                                    <form class="form" action="#" method="POST">
                                                        ...
                                                        <!--begin::Input group-->
                                                        <div class="d-flex flex-column mb-5 fv-row">
                                                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">Slug</label>
                                                            <input type="text" class="form-control form-control-solid" placeholder="" name="username" required />
                                                            <div class="text-danger mt-1 small"><em>Password Default : <strong>12345678</strong></em></div>
                                                        </div>
                                                        <!--end::Input group-->
                            ...
                            <div class="card-body py-3 pt-10">
                                ...
                                <div class="table-responsive">
                                    <!--begin::Table-->
                                    <table id="category_table" class="table table-striped border rounded gy-5 gs-7 dataTable no-footer">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($categories as $category)
                                                <tr>
                                                    <td>{{ $no++ }}</td>
                                                    <td>{{ $category->name }}</td>
                                                    <td class="text-center">{{ $category->qty }}</td>
                                                    <td class="text-center">
                                                        <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" title="Edit" data-bs-toggle="modal" data-bs-target="#modal_edit_karyawan_{{ $category->id }}" >
