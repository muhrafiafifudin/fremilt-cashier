                                            ...
                                            @foreach ($products as $product)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" title="Edit" data-bs-toggle="modal" data-bs-target="#modal_edit_karyawan_{{ $product->id }}" >
