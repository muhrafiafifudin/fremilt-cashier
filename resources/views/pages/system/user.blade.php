        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-3">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Karyawan
                        <!--begin::Separator-->
                    ...
                    <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    ...
                                    <span class="text-muted mt-1 fw-bold fs-7">Menampilkan semua karyawan yang ada</span>
                                </h3>
                                <div class="card-toolbar">
                                    <div class="button-add">
                                        ...
                                        <!--end::Svg Icon-->Tambah Karyawan</a>
                                    </div>
                                </div>
                                        ...
                                        <div class="modal-content rounded">
                                            ...
                                            <div class="modal-body px-10 px-lg-15 pt-0 pb-15">
                                                ...
                                                <div class="mb-13 text-center">
                                                    ...
                                                    <div class="text-gray-400 fw-bold fs-5">Form Untuk Penambahan Data Karyawan</div>
                                                </div>
                                                <!--end::Heading-->
                                                <!--begin::Scroll-->
                                                <div class="scroll-y me-n7 pe-7" id="kt_modal_new_target_form" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
                                                    ...
                                                    <form class="form" action="{{ route('user.store') }}" method="POST">
                                                        ...
                                                        <div class="d-flex flex-column mb-5 fv-row">
                                                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">Nama Karyawan</label>
                                                            <input type="text" class="form-control form-control-solid" placeholder="Masukkan nama" name="name" required />
                                                        </div>
                                                        <!--end::Input group-->
                                                        ...
                                                        <div class="d-flex flex-column mb-5 fv-row">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid" placeholder="Masukkan email" name="email" required />
                                                            <div class="text-danger mt-1 large"><em>Password Default : <strong>12345678</strong></em></div>
                                                        </div>
                                                        <!--end::Input group-->
                            ...
                            <div class="card-body py-3 pt-10">
                                ...
                                <div class="table-responsive">
                                    <!--begin::Table-->
                                    <table id="employee_table" class="table table-striped border rounded gy-5 gs-7 dataTable no-footer">
                                        <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <form action="{{ route('user.destroy', \Crypt::encrypt($user->id)) }}" method="POST">
                                                            ...
                                                            <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" title="Edit" data-bs-toggle="modal" data-bs-target="#modal_edit_user_{{ $user->id }}" >
                                    ...
                                    @foreach ($users as $user)
                                        <!--begin::Modal - New Target-->
                                        <div class="modal fade" id="modal_edit_user_{{ $user->id }}" tabindex="-1" aria-hidden="true">
                                            <!--begin::Modal dialog-->
                                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                                <!--begin::Modal content-->
                                                <div class="modal-content rounded">
                                                    ...
                                                    <div class="modal-body px-10 px-lg-15 pt-0 pb-15">
                                                        ...
                                                        <div class="mb-13 text-center">
                                                            ...
                                                            <div class="text-gray-400 fw-bold fs-5">Form Untuk Mengubah Data Karyawan</div>
                                                        </div>
                                                        <!--end::Heading-->
                                                        <!--begin::Scroll-->
                                                        <div class="scroll-y me-n7 pe-7" id="kt_modal_new_target_form" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
                                                            <!--begin:Form-->
                                                            <form class="form" action="{{ route('user.update', \Crypt::encrypt($user->id)) }}" method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                                ...
                                                                <div class="d-flex flex-column mb-5 fv-row">
                                                                    <label class="d-flex align-items-center fs-6 fw-bold mb-2">Nama Karyawan</label>
                                                                    <input type="text" class="form-control form-control-solid" placeholder="Masukkan nama" name="name" value="{{ $user->name }}" />
                                                                </div>
                                                                <!--end::Input group-->
                                                                ...
                                                                <div class="d-flex flex-column mb-5 fv-row">
                                                                    <label class="d-flex align-items-center fs-6 fw-bold mb-2">Email</label>
                                                                    <input type="text" class="form-control form-control-solid" placeholder="Masukkan email" name="email" value="{{ $user->email }}" />
                                                                    <div class="text-danger mt-1 large"><em>Password Default : <strong>12345678</strong></em></div>
                                                                </div>
                                                                <!--end::Input group-->
...
@push('javascript')
    <script src="{{ asset('assets/js/pages/main/employee.js') }}"></script>
